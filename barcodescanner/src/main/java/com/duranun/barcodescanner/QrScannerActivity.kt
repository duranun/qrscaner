...
import com.duranun.barcodescanner.databinding.ActivityQrScannerBinding
import com.duranun.barcodescanner.ext.showAlert
import com.duranun.barcodescanner.ext.visibleIf
import com.duranun.barcodescanner.helpers.CameraOptions


class QrScannerActivity : AppCompatActivity() {
    private var codeVerificationEnabled: Boolean = true
        ...
        binding.btnQrScannerOk.setOnClickListener {
            binding.code.text?.let { editable ->
                when (codeVerificationEnabled) {
                    ...
                    else -> setCode(editable.toString())
                }
            }
        }
    ...
    private fun setCameraOptions(cameraOptions: CameraOptions) {
        ...
        this.codeVerificationEnabled = cameraOptions.codeVerificationEnabled
